...
<form action="" method="POST">
	...
	<label>
	<span>Podaj temat i treść wiadomości:</span>
	<input type="text" name="mail_subject" class="wpis" placeholder="Temat wiadomości">
	</label>

	<label>

	<textarea type="text" name="mail_body" class="wiadomosc" style="width: 800px; height: 300px;" placeholder=" Twoja wiadomosc"></textarea>
	</label>
	<br><br>
